...
@PrimaryKeyJoinColumn(name = "persona_id") // Cual es la primay key para identificarlo en la tabla de la herencia
public class Empleado extends Persona{

    private BigDecimal sueldo;
    @Column(name = "tipo_empleado")
    @Enumerated(EnumType.STRING) // Anotación para decir que es un enumerador y que persista como un String
